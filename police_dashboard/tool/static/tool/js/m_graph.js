function renderGraph(data,div_name){
    ...
    //end slider part----------------------------------------------------------------------------------- 
       ...
       stroke_dasharray.domain(d3.keys(data[0]).filter(function(key) { // Set the domain of the color ordinal scale to be all the csv headers except "date", matching a color to an issue
        return key !== "date"; 
      }));
      ...
      data.forEach(function(d) { // Make every date in the csv data a javascript date object format
        ...
        // d.date = parseDate(d_date.toString());
        // console.log(d_date.toString())
     ...
     var brush = d3.svg.brush()//for slider bar at the bottom
      ...
      issue.append("path")
          ...
          .style("stroke-dasharray", function(d){ return stroke_dasharray(d.name)});
      ...
      var hoverLine = hoverLineGroup // Create line with basic attributes
            .append("line")
                ...
                .style("pointer-events", "none") // Stop line interferring with cursor
                // .style("opacity", 0.5); // Set opacity to zero 
